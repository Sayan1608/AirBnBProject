...
import com.codingshuttle.projects.repositories.HotelMinPriceRepository;
...
public class InventoryServiceImpl implements InventoryService{
    ...
    @Override
    public Page<HotelPriceDto> searchHotelBasedOnInventory(HotelSearchRequest hotelSearchRequest) {
        Pageable pageable = PageRequest.of(hotelSearchRequest.getPage(),hotelSearchRequest.getSize());
        long daysCount =
                ChronoUnit.DAYS.between(hotelSearchRequest.getStartDate(), hotelSearchRequest.getEndDate()) + 1;

        Page<HotelPriceDto> hotelPage = hotelMinPriceRepository.getHotelByInventories(hotelSearchRequest.getCity(), hotelSearchRequest.getStartDate()
